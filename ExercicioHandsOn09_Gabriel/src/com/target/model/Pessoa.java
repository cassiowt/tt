...
//	@NamedQuery(name = "pessoa.count", query = "select count(p) from Pessoa p"),
	...
	@NamedQuery(name = "aluno.byApelidoAsc", query = "select a from Aluno a order by a.apelido"),
...
//	@NamedQuery(),
	@NamedQuery(name = "cliente.telefone.byTipo", query= "select c from Cliente c join c.telefones t where t.tipo = :tipo")
})
